...
var now_project = 'settle';//settle(结算)
var file_road = {
    cssSrc: './' + now_project + '/src/less/**/*.less',
    cssDst: './' + now_project + '/static/css',
    imgDst_sprite: './static/sprite/spritesheet.png', //--本例未使用
    imgDst_sprite_css: '../sprite/spritesheet.png', //--本例未使用

    imgSrc: './' + now_project + '/src/img/**/*',
    imgDst: './' + now_project + '/static/img',
    imgSrc_sprite: './src/img/**/*.png',//--本例未使用

    jsLocal: './src/js/**/*.js',//--本例未使用
